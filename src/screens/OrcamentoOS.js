                    ...
                    return (
                      <View key={orc.orc_codigo} style={styles.orcamentoItem}>
                        ...
                        <View style={styles.actionIcons}>
                          <TouchableOpacity
                            onPress={() => handleReabrirOrcamento(orc.orc_codigo, item.os_codigo)}
                          >
                            <Icon name="repeat" type="font-awesome" size={20} color="#007bff" />
                          </TouchableOpacity>
                          <TouchableOpacity
                            onPress={() =>
                              navigation.navigate("ReplicaOrcamento", {
                                orcamentoId: orc.orc_codigo,
                                osId: item.os_codigo,
                              })
                            }
                          >
                            <Icon name="copy" type="font-awesome" size={20} color="#28a745" />
                          </TouchableOpacity>
                        </View>
